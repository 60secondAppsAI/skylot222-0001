...
<template>
  ...
  <base-input label="DiscountPercent" type="text" placeholder="Enter DiscountPercent" v-model="promotionToAdd.discountPercent"></base-input>
    ...
    return {
      ...
      columns: [
		...
		dataIndex: 'discountPercent',
          ...
          //sorter: (a, b) => a.discountPercent.localeCompare(b.discountPercent),
        },
        {
          title: 'Start Date',
		dataIndex: 'startDate',
