              ...
              <button @click="handlePermissionDialogClose">OK</button>
					...
					<td class="detail_view_column_2">Promotion Id</td>
							...
							<div class="detail_view_input" style="display: inline-flex;">
															...
															<tr> 
					<td class="detail_view_column_2">Discount Percent</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="DiscountPercent" type="text" placeholder="Enter DiscountPercent" v-model="promotionDetails.discountPercent"></input>
																		</div>
						</td>
														</tr>
															<tr> 
